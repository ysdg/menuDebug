1. pretreatment of C file: filePreDeal.py
...
2. excel opreation based on openpyxl: 
	including excel writing and reading.
3. transfer C file to excel: 
	transfer code in C file to excel process.
4. deal with message input:
	such as machine code, time, file name.